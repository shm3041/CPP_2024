...
/*
이번 과제에서는 print멤버 함수에 virtual키워드를 사용하여 참조형식에서 실형식으로 형식을 바꿔주었다. 
본래 C++는 참조 형식을 기본으로 사용하여 각 직업에서 print함수를 사용 시 Character*형식으로 배열을 관리하기 때문에 
Character의 print함수가 사용되어야 했다. 하지만 virtual 키워드를 사용해줘서 각 직업의 print함수를 사용할 수 있게 
해주었다. 또한, 개발자의 입장에서 가독성이 편하도록 override 키워드를 사용하여 줬다.
*/